...
<!-- Mirrored from themesdesign.in/medroc/layouts/auth-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Mar 2022 11:31:32 GMT -->
<head>
                    ...
                    <div class="card overflow-hidden mt-2">
                        ...
                        <div class="card-body position-relative">
                            <div class="p-4 mt-n5 card rounded">
                                <form class="form-horizontal" action="{{ route('admin-validate_registration') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
