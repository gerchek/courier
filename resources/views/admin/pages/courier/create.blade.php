            ...
            <div class="card-body">
                ...
                @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="email" placeholder="examle@example.com" id="example-email-input" name="email">
                        </div>
                    </div>
                    @if ($errors->has('email'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="example-text-input" name="state">
                        </div>
                    </div>
                    @if ($errors->has('state'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="example-text-input" name="salary">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="example-text-input" name="payment_method">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="date" value="2011-08-19" id="example-date-input" name="pay_date">
                        </div>
                    </div>
